...
//   const fetchedBook = new FetchBook()
//   fetchedBook.fetchElement(id)
//   .then(bookData => {
//   console.log(bookData);
//   return createBookMarkup(bookData);
// })
// }).join('')

// container.innerHTML = mapIds
...
container.innerHTML = bookMarkups.join('');
