let e;function t(e,t,n,o){Object.defineProperty(e,t,{get:n,set:o,enumerable:!0,configurable:!0})}function n(e){return e&&e.__esModule?e.default:e}var o="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},i={},r={},a=o.parcelRequirea837;null==a&&((a=function(e){if(e in i)return i[e].exports;if(e in r){var t=r[e];delete r[e];var n={id:e,exports:{}};return i[e]=n,t.call(n.exports,n,n.exports),n.exports}var o=Error("Cannot find module '"+e+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(e,t){r[e]=t},o.parcelRequirea837=a),a.register("kyEFX",function(e,n){"use strict";t(e.exports,"register",function(){return o},function(e){return o=e}),t(e.exports,"resolve",function(){return i},function(e){return i=e});var o,i,r={};o=function(e){for(var t=Object.keys(e),n=0;n<t.length;n++)r[t[n]]=e[t[n]]},i=function(e){var t=r[e];if(null==t)throw Error("Could not resolve bundle with id "+e);return t}}),a("kyEFX").register(JSON.parse('{"kROXL":"index.01a1d864.js","lp5u4":"sprite.706b91f7.svg","k92he":"index.16c4825e.js","1HyLC":"index.5c2819ad.css","49Xxz":"index.c5ed4124.js"}')),a("dWN8B");var l=(a("2sKPt"),a("2sKPt"));function s(e){let{list_name:t,books:n}=e,o=n.map(({title:e,author:t,book_image:n,_id:o})=>`
  ...
  `}const c=document.querySelector(".cont-section"),d=document.querySelector(".loader-inner"),u=new l.FetchBook;async function f(e){try{d.style.display="flex",c.innerHTML="";let t=await u.fetchElement("/top-books");!function(e,t){let n=function(e,t){let n=`<div class="container grid-wrapper">
      ...
      </h2>`,o=e.map(({list_name:e,books:n})=>({list_name:e,books:n.slice(0,t)}));return`${n}${o.map(s).join("")}`}(e,t);c.insertAdjacentHTML("beforeend",n)}(t,e)}catch(e){console.log(e)}finally{d.style.display="none"}}function m(){let t=window.innerWidth;c.addEventListener("click",function(e){let t=e.target.dataset.listname;y(t)}),e&&clearTimeout(e),e=setTimeout(()=>{window.removeEventListener("resize",m),t>=1440?f(5):t>=768?f(3):f(1),window.addEventListener("resize",m)},300)}m(),window.addEventListener("resize",m);const v=document.querySelector(".aside-list"),p=document.querySelector(".cont-section"),h=document.querySelector(".categories-list-name"),b=document.querySelector(".loader-inner"),g=new l.FetchBook;function y(e){!function(e){let t=document.querySelectorAll(".aside-link");h.classList.remove("activ-name"),t.forEach(t=>{t.classList.remove("activ-name"),t.textContent===e&&t.classList.add("activ-name")})}(e),b.style.display="flex",g.fetchElement(`/category?category=${e}`).then(t=>{let n=t.map(e=>(function(e){let{book_image:t,title:n,author:o,_id:i}=e;return`
    <li class="cards-item">
  ...
  <ul class="card-list">${e}</ul>
    ...
    </button>`;let i=document.querySelector(".js-addBtn");i.addEventListener("click",function o(i){n.push(t),localStorage.setItem("bookList",JSON.stringify(n)),e(t),i.currentTarget.removeEventListener("click",o),(0,j.addToFierbase)()})}}(e.target.dataset.id)}document.querySelector(".backdrop"),O.addEventListener("click",H);const F=document.querySelectorAll(".menu-link");F.forEach(e=>e.classList.remove("activ-page")),F[0].classList.add("activ-page");const A=document.querySelectorAll(".mob-menu-link");A.forEach(e=>e.classList.remove("activ-page")),A[0].classList.add("activ-page"),a("iiT47");var M={},B={},N={};N=function(e){var t=typeof e;return null!=e&&("object"==t||"function"==t)};var R={},z={},X={};X="object"==typeof o&&o&&o.Object===Object&&o;var C="object"==typeof self&&self&&self.Object===Object&&self;z=X||C||Function("return this")(),R=function(){return z.Date.now()};var W={},D={},P={},I=/\s/;P=function(e){for(var t=e.length;t--&&I.test(e.charAt(t)););return t};var J=/^\s+/;D=function(e){return e?e.slice(0,P(e)+1).replace(J,""):e};var U={},Y={},K={};K=z.Symbol;var G={},Q=Object.prototype,V=Q.hasOwnProperty,Z=Q.toString,ee=K?K.toStringTag:void 0;G=function(e){var t=V.call(e,ee),n=e[ee];try{e[ee]=void 0;var o=!0}catch(e){}var i=Z.call(e);return o&&(t?e[ee]=n:delete e[ee]),i};var et={},en=Object.prototype.toString;et=function(e){return en.call(e)};var eo=K?K.toStringTag:void 0;Y=function(e){return null==e?void 0===e?"[object Undefined]":"[object Null]":eo&&eo in Object(e)?G(e):et(e)};var ei={};ei=function(e){return null!=e&&"object"==typeof e},U=function(e){return"symbol"==typeof e||ei(e)&&"[object Symbol]"==Y(e)};var er=0/0,ea=/^[-+]0x[0-9a-f]+$/i,el=/^0b[01]+$/i,es=/^0o[0-7]+$/i,ec=parseInt;W=function(e){if("number"==typeof e)return e;if(U(e))return er;if(N(e)){var t="function"==typeof e.valueOf?e.valueOf():e;e=N(t)?t+"":t}if("string"!=typeof e)return 0===e?e:+e;e=D(e);var n=el.test(e);return n||es.test(e)?ec(e.slice(2),n?2:8):ea.test(e)?er:+e};var ed=Math.max,eu=Math.min;B=function(e,t,n){var o,i,r,a,l,s,c=0,d=!1,u=!1,f=!0;if("function"!=typeof e)throw TypeError("Expected a function");function m(t){var n=o,r=i;return o=i=void 0,c=t,a=e.apply(r,n)}function v(e){var n=e-s,o=e-c;return void 0===s||n>=t||n<0||u&&o>=r}function p(){var e,n,o,i=R();if(v(i))return h(i);l=setTimeout(p,(e=i-s,n=i-c,o=t-e,u?eu(o,r-n):o))}function h(e){return(l=void 0,f&&o)?m(e):(o=i=void 0,a)}function b(){var e,n=R(),r=v(n);if(o=arguments,i=this,s=n,r){if(void 0===l)return c=e=s,l=setTimeout(p,t),d?m(e):a;if(u)return clearTimeout(l),l=setTimeout(p,t),m(s)}return void 0===l&&(l=setTimeout(p,t)),a}return t=W(t)||0,N(n)&&(d=!!n.leading,r=(u="maxWait"in n)?ed(W(n.maxWait)||0,t):r,f="trailing"in n?!!n.trailing:f),b.cancel=function(){void 0!==l&&clearTimeout(l),c=0,o=s=i=l=void 0},b.flush=function(){return void 0===l?a:h(R())},b},M=function(e,t,n){var o=!0,i=!0;if("function"!=typeof e)throw TypeError("Expected a function");return N(n)&&(o="leading"in n?!!n.leading:o,i="trailing"in n?!!n.trailing:i),B(e,t,{leading:o,maxWait:t,trailing:i})};const ef=document.querySelector(".scroll-to-top"),em=n(M)(function(){let e=window.scrollY,t=document.documentElement.clientHeight;function n(){window.scrollTo({top:0,behavior:"smooth"})}e>=t?(ef.addEventListener("click",n),ef.classList.remove("unvisually")):(ef.classList.add("unvisually"),ef.addEventListener("click",n))},500);window.addEventListener("scroll",em),a("lohXh");
//# sourceMappingURL=index.01a1d864.js.map
